    ...
    <footer className="bg-foreground text-background">
      <div className="border-b border-background/10 py-16 lg:py-20">
        <div className="container text-center">
          <ScrollReveal>
            <h2 className="mb-4 text-3xl font-bold lg:text-4xl">{t.footer.ctaTitle}</h2>
          </ScrollReveal>
          <ScrollReveal delay={0.1}>
            <p className="mx-auto mb-8 max-w-xl text-background/70">{t.footer.ctaDesc}</p>
          </ScrollReveal>
          ...
          >
            <div className="sm:col-span-2 lg:col-span-1">
              <a href="#" className="mb-4 flex items-center gap-2">
                ...
                <span className="text-xl font-bold">Itech Pro</span>
              </a>
      ...
      <div className="border-t border-background/10 py-6">
        <div className="container flex flex-col items-center justify-between gap-4 text-center sm:flex-row sm:text-start">
          <p className="text-sm text-background/60">{t.footer.copyright}</p>
          <p className="text-xs text-background/40">{t.footer.disclaimer}</p>
        </div>
      </div>
    </footer>
  );
